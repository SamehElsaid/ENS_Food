...
async function HeaderBar({ children, lng }) {
  ...
  return (
    <div className="flex || gap-1 || flex-col-reverse || lg:flex-row">
      ...
      <div
        className={`${
          pathName === "/" + lng ? "" : "hidden lg:flex"
        } w-full || h-[220px] || lg:h-screen || pt-[60px] || lg:pt-[100px] || relative || flex || || flex-col || justify-center`}
      >
        <div
          className={`${
        ...
        >
          ...
          <div className="flex || items-center || gap-5">
            ...
            {languages
              ...
              .map((tran) => (
                <h2
                  className="w-[44px] || h-[44px] || flex || items-center || justify-center || bg-[#f4f4f4] || lg:bg-transparent || rounded-full"
                  key={tran}
                >
                  <Link
                   prefetch={false}
        ...
        <div className=" relative || w-full || flex-1 || lg:flex-none || h-[150px] || lg:h-[500px]">
          <Image
            loading="eager"
            priority
